...
<?php if (!$wmode) { ?>
	...
	<footer class="footer-new">
		<div>
			<div>
				<img src="<?php echo G5_IMG_URL ?>/bottomLogo.png" alt="">
				<ul>
					<li>카카오톡 채널추가</li>
					<li>상품후기</li>
					<li>1:1문의</li>
			...
			<div>
				<p>CS CENTER 1522-2041 <span>|</span> 평일 10:00 ~ 17:00 (점심 12:00 ~ 13:00)</p>
				<p>soo@p2u.kr <span>|</span> 토요일, 일요일, 공휴일은 휴무입니다. 근무시간 이후 문의는 1:1 문의를 이용해주세요.</p>
			</div>
			<div>
				<p>주식회사 포인투유 <span>|</span> 대표 : 최병호</p>
				<p>사업자 등록번호 : 443-86-024-22 <span>|</span> 통신판매업 : 제2024-서울금천-0326호 <span>|</span> 주소 : 08502 서울 금천구 가산디지털1로 212 202-52호 (가산동, 코오롱디지털타워애스턴)</p>
			</div>
			<div class="copyright">Copyright © P2U :: 포인투유. All Rights Reserved</div>
			<div class="terms">
				<ul>
					<li>이용약관</li>
					<li>개인정보처리방침</li>
